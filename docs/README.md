...
- [octoacme-project-management-overview.md](octoacme-project-management-overview.md) — Principles, roles, artifacts, and lifecycle
- [octoacme-project-initiation.md](octoacme-project-initiation.md) — One-pager template, stakeholder alignment, decision gates
- [octoacme-project-planning.md](octoacme-project-planning.md) — Backlog creation, estimation, risk management, milestones
- [octoacme-execution-and-tracking.md](octoacme-execution-and-tracking.md) — Rhythms, workflows, testing, reporting
- [octoacme-risks-and-communication.md](octoacme-risks-and-communication.md) — Risk lifecycle, stakeholder updates, escalation
- [octoacme-release-and-deployment.md](octoacme-release-and-deployment.md) — Pre-release, deployment checklists, rollbacks
- [octoacme-retrospective-and-continuous-improvement.md](octoacme-retrospective-and-continuous-improvement.md) — Learning capture, action items, improvement culture
- [octoacme-roles-and-personas.md](octoacme-roles-and-personas.md) — Project manager, product manager, developer responsibilities

## Issue Templates

- [.github/ISSUE_TEMPLATE/add-update-content-to-process-docs.yml](../.github/ISSUE_TEMPLATE/add-update-content-to-process-docs.yml) — Template for proposing additions or updates to process documentation
